 ...
 * @author Mesong
 */
public class doSearchTransaction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<TransactionHeader> transactionList = tranDB.listTransaction();

         
            session.setAttribute("transactionlist", transactionList);

            response.sendRedirect("managerPage/transactionAdminPage.jsp?page=1");
        } finally {
            out.close();
        }
    }
