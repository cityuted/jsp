            ...
            <div class="content-wrapper">
                ...
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Delete Toy</h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="box-body">
                        <form  method='post' action='/toy/doDeleteToy' >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name='toyName' readonly  id='toyName' class="form-control" required value='<%= t.getToyName()%>'>
                            </div>

                            <!-- textarea -->
                            <div class="form-group">
                                <label>Description</label>
                                <textarea class="form-control" name='description' readonly  id='description' rows="3" ><%= t.getDescription()%></textarea>
                            </div>

                            <div class="form-group">
                                <label>Cashpoint</label>
                                <input type="number" class="form-control" readonly name='cashpoint' min="0" required value="<%= t.getCashpoint()%>">
                            </div>

                            <div class="form-group">
                                <label>QTY</label>
                                <input type="number" class="form-control" readonly  name='qty'  min="0" required value="<%= t.getQTY()%>">
                            </div>

                            <div class="form-group">
                                <label>Discount(%)</label>
                                <input type="number" class="form-control" readonly name='discount' min="0" required value="<%=t.getDiscount()%>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" readonly id="secondHand" name="secondHand">
                            ...
                            <div class="form-group">
                                ...
                                <select multiple="" name="category" disabled="" id="category" class="form-control">
                            ...
                            <div class="box-footer">
                                <button class="btn btn-danger " type='button' onclick="history.go(-1);return true;">Back</button>
