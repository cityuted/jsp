            ...
            <div class="content-wrapper">
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body row-sm-8">
                        <form  method='post' action='/toy/doUpdateTransaction' >
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name='payment' id='payment' value="<%=header.getPayment()%>" >

                            </div>    

                            <div class="form-group">
                                <label>Delivery Progress</label>
                                <select class="form-control" name='deliveryProgress' id='deliveryProgress'  >
