            ...
            <div class="content-wrapper">
                ...
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Update Customer Profile</h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="box-body row-sm-8">
                        ...
                        <form  method='post' action='/toy/doUpdateCustomer'  >
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <textarea type="text" name='custAddress'   id='custAddress' class="form-control" required ><%= user.getUserAddress()%></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  disabled class="form-control" required value='<%= user.getCashpoint()%>'>
                                <input type="hidden" name='cashpoint' id='cashpoint' value="<%=user.getCashpoint()%>" >


                            </div>
                                <label>Add Cashpoint</label>
