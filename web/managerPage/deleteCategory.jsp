            ...
            <div class="content-wrapper">
                ...
                <%
                    ...
                    if(request.getParameter("categoryID")!=null) {
                     ...
                     Category c = categorydb.searchCategory(categoryID);
                %>
                <!-- Main content -->
                <div class="box box-warning">
                    ...
                    <div class="box-body row-sm-8">
                        ...
                        <form  method='post' action='/toy/doDeleteToyCategory'  >

                            <div class="form-group">
                                <label>Category ID</label>
                                <input type="text" class="form-control" value="${param.categoryID}" disabled="">
                                <input type="hidden" name='cateogryID' id='cateogryID' value="${param.categoryID}" >
                            </div>
                            <!-- text input -->
                            <div class="form-group">
                                <label>Category Name</label>
                                <input type="text" name='categoryName' disabled=""  id='categoryName' class="form-control" required value='<%= c.getCategoryName() %>'>
                            </div>
