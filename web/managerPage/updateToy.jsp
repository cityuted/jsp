            ...
            <div class="content-wrapper">
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body row-sm-8">
                        ...
                        <form  method='post' action='/toy/doUpdateToy' enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name='toyName'   id='toyName' class="form-control" required value='<%= t.getToyName().substring(0, t.getToyName().length()-13) %>'>
                            </div>

                            <!-- textarea -->
                            <div class="form-group">
                                <label>Description</label>
                                <textarea class="form-control" name='description'  id='description' rows="3" ><%= t.getDescription()%></textarea>
                            </div>
                            <div class="form-group">
                                <label>Toy Icon</label>
                                <input id="uploadImage" type="file" name="myPhoto"  accept=".png"  />
                                 <input id="uploadString" type="hidden" name="uploadString"  value=""   />
                            </div>

                            <div class="form-group">
                                <label>Cashpoint</label>
                                <input type="number" class="form-control" name='cashpoint' min="0" required value="<%= t.getCashpoint()%>">
                            </div>

                            <div class="form-group">
                                <label>QTY</label>
                                <input type="number" class="form-control" name='qty'  min="0" required value="<%= t.getQTY()%>">
                            </div>

                            <div class="form-group">
                                <label>Discount(%)</label>
                                <input type="number" class="form-control" name='discount' min="0" required value="<%=t.getDiscount()%>">
                            </div>
                                    ...
                                    <%
                                        ...
                                        for (Category c : categoryList) {
                                            ...
                                            if (!isSelected) {
                                                ...
                                                out.println(String.format("<option value='%s' selected>%s</option>", c.getCategoryID() + separator, c.getCategoryID() + "-" + c.getCategoryName()));
                                            }
                                        }
                                    %>
