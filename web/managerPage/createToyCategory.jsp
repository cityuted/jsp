        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="box box-warning">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form  method='post' action='/toy/doCreateToyCategory'  >
                            <div class="form-group">
                                <label>Category ID</label>
                                <% int lastIndex = catdb.getAutoIncrement("CATEGORY");%>
                                <input type="text" class="form-control" value="<%= lastIndex %>" disabled="">
                                <input type="hidden" name='categoryID' id='categoryID' value="<%= lastIndex %>" >
                            </div>
                            <!-- text input -->
                            <div class="form-group">
                                <label>Category Name</label>
                                <input type="text" name='categoryName'   id='categoryName' class="form-control" required value=''>
                            </div>
